...
- [HTTPS化（Tailscale Serve）](#https化tailscale-serve)
  - [背景](#背景)
  - [仕組み](#仕組み)
  - [前提条件](#前提条件)
  - [コマンド](#コマンド)
  - [iPhoneからのアクセス](#iphoneからのアクセス)
  - [Tailnet での Serve 有効化](#tailnet-での-serve-有効化)
  - [ライフサイクル](#ライフサイクル)
  - [依存関係](#依存関係)
- [ユニバーサルバイナリ対応](#ユニバーサルバイナリ対応)
  - [現状](#現状)
  - [影響を受ける箇所](#影響を受ける箇所)
  - [ユニバーサルバイナリ対応の手順（未実施）](#ユニバーサルバイナリ対応の手順未実施)
  - [備考](#備考)
